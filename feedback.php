...
<div class="col-md-6 panel" style="background-image:url(image/bg1.jpg); min-height:560px;min-height: 492px;padding: 0px 29px;margin: 30px;">
<h2 align="center" style="font-family:'typo'; color:#000066">Feedback/Report a Problem</h2>
<div style="font-size:14px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo'
<span style=" line-height:20.5px;font-family:typo">You can send us your feedback through e-mail on the following e-mail id: <a href="mailto:imrsharmaofficial@gmail.com" style="color:#000000;">imrsharmaofficial@gmail.com</a><br />
Or you can directly submit your feedback by filling the enteries below:-</span>
...
<div class="row">
<div class="col-md-3" style=""><b>Name: <small style="color:#f47141">*</small></b><br /><br /><br /><b>Subject: <small style="color:#f47141">*</small></b></div>
<div class="col-md-9">
<!-- Text input-->
<div class="form-group">
...
<input style="width:100px;height:42px;border-radius:20px; margin-top:10px" type="submit" name="submit" value="Submit" class="btn btn-primary" />
</div>
</form>';}?>
</div><!--col-md-6 end-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:#42f4d7">Developers</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Our Company" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9711190164</h4>
		<h4 style="font-family:'typo' ">imrsharmaofficial@gmail.com</h4>
